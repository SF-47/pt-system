    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientMealPlans_MealPlans_MealPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientWorkoutAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientWorkoutAssignments_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientWorkoutAssignments_WorkoutPlans_WorkoutPlanId",
            ...
            migrationBuilder.CreateTable(
                name: "ClientMealStatuses",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ClientMealPlanId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientMealStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientMealStatuses_ClientMealPlans_ClientMealPlanId",
                        column: x => x.ClientMealPlanId,
                        principalTable: "ClientMealPlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClientMealStatuses_Meals_MealId",
                        column: x => x.MealId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientMealPlans_MealPlanId",
                table: "ClientMealPlans",
                column: "MealPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientMealStatuses_ClientMealPlanId",
                table: "ClientMealStatuses",
                column: "ClientMealPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientMealStatuses_MealId",
                table: "ClientMealStatuses",
                column: "MealId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientWorkoutAssignments_WorkoutPlanId",
                table: "ClientWorkoutAssignments",
