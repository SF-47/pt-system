export default function Loading() {
  return (
    <div aria-label="Loading workout plan" aria-busy="true" className="w-full animate-pulse">
      ...
      <div className="overflow-hidden rounded-xl border border-border bg-surface">
        ...
        {[0, 1, 2, 3].map((row) => (
          <div key={row} className="grid grid-cols-[3fr_0.6fr_0.6fr_0.8fr] gap-4 border-t border-border px-4 py-3">
