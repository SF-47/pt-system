...
export default async function ClientDetailsPage({ params }: ClientPageProps) {
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-start gap-3 [&>span:first-child]:size-11 [&>span:first-child]:text-[15px] min-[761px]:gap-[18px] min-[761px]:[&>span:first-child]:size-16 min-[761px]:[&>span:first-child]:text-[21px] [&>div>header]:mb-2.5">
      ...
      <div className="grid grid-cols-1 gap-4 min-[761px]:grid-cols-2">
        <section className="rounded-[9px] border border-border bg-surface p-5 min-[761px]:row-span-2">
        ...
        <section className="rounded-[9px] border border-border bg-surface p-5">
          <h2 className="mb-3 text-lg font-semibold">Payment Status</h2>
          <StatusBadge status={client.paymentStatus} />
        </section>
        <section className="rounded-[9px] border border-border bg-surface p-5">
          <h2 className="mb-3 text-lg font-semibold">Assigned Workout Plans</h2>
          <p className="text-muted">
            Workout assignments are not available in the current data.
          </p>
        </section>
        <section className="rounded-[9px] border border-border bg-surface p-5">
          <h2 className="mb-3 text-lg font-semibold">Assigned Meal Plans</h2>
          <p className="text-muted">
            Meal assignments are not available in the current data.
          </p>
        </section>
        <section className="rounded-[9px] border border-border bg-surface p-5 min-[761px]:col-span-full">
